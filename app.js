...
var $author$project$PhotoGroove$GotRandomIndex = function (a) {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'ClickedSurprise':
				return _Utils_Tuple2(
					model,
					A2($elm$random$Random$generate, $author$project$PhotoGroove$GotRandomIndex, $author$project$PhotoGroove$randomPhotoPicker));
			case 'ClickedSize':
				var size = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
